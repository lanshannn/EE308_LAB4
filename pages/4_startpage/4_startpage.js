...
Page({
  ...
  click: function (options) {
    ...
    var _3one, _3two, _3three, _3four, _3five, _3six;
    self.setData({
      hiddenTones: 'flex',
      button: stopAddress,
    });
    if(isnotClick){
      ...
      _3one = Math.floor((Math.random() * 6));
      _3two = Math.floor((Math.random() * 6));
      _3three = Math.floor((Math.random() * 6));
      _3four = Math.floor((Math.random() * 6));
      _3five = Math.floor((Math.random() * 6));
      _3six = Math.floor((Math.random() * 6));
      ...
      self.setData({
        ...
        sixTonesComputerPlayer_3: [_3one, _3two, _3three, _3four, _3five, _3six],
      })
    },100);
    // toning
  ...
  clicked: function(){
    wx.navigateTo({
      url: '../5_record/record?num={{this.data.order.index("User")}}',
    })
  },
  /**
